...
- **Deal and offer posts** — Promotional graphics for specials, meal deals, and seasonal offers
- **Google Business updates** — Concise, keyword-rich posts to keep the Google profile active and visible in local search

Each post gets a platform-specific caption written in the restaurant's brand voice, with relevant hashtags and a call to action.
