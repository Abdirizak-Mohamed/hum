...
async function seed() {
  ...
  await contentItemRepo.create(db, {
    ...
    mediaUrls: ['https://cdn.hum.app/media/alis-doner-hero.jpg'],
  ...
  await contentItemRepo.create(db, {
    ...
    mediaUrls: ['https://cdn.hum.app/media/dragon-dimsum-spread.jpg'],
    platforms: ['facebook'],
    status: 'scheduled',
  ...
  await contentItemRepo.create(db, {
    ...
    mediaUrls: ['https://cdn.hum.app/media/tonys-nduja-pull.jpg'],
    platforms: ['instagram'],
    status: 'scheduled',
  ...
  await contentItemRepo.create(db, {
    ...
    hashtags: [],
    mediaUrls: ['https://cdn.hum.app/media/alis-nighttime-exterior.jpg'],
  ...
  const postedDraft = await contentItemRepo.create(db, {
    ...
    mediaUrls: ['https://cdn.hum.app/media/dragon-peking-duck-review.jpg'],
    platforms: ['instagram', 'facebook'],
    status: 'draft',
  });
  ...
  await contentItemRepo.create(db, {
    ...
    mediaUrls: ['https://cdn.hum.app/media/tonys-tuesday-deal.jpg'],
    platforms: ['instagram', 'facebook'],
    status: 'failed',
  ...
  await contentItemRepo.create(db, {
    ...
    mediaUrls: ['https://cdn.hum.app/media/tonys-dough-stretch-reel.mp4'],
    platforms: ['instagram'],
    status: 'failed',
